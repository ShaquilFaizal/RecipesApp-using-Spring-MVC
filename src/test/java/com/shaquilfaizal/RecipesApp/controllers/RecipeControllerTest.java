...
public class RecipeControllerTest {
	...
	public void testGetRecipe() throws Exception {
		...
		when(recipeService.findById(Matchers.anyLong())).thenReturn(recipe);
	...
	public void testPostNewRecipeForm() throws Exception {
		...
		when(recipeService.saveRecipeCommand(Matchers.any())).thenReturn(command);
...
//                .param("description", "some string")
	...
	public void testGetUpdateView() throws Exception {
		...
		when(recipeService.findCommandById(Matchers.anyLong())).thenReturn(command);
