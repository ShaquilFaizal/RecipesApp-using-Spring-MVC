...
public class Recipe {
	...
	@Getter @Setter private Integer prepTime;
	@Getter @Setter private Integer cookTime;
	@Getter @Setter private Integer servings;
	...
	@Getter @Setter private Set<Ingredient> ingredients = new HashSet<>();
	
	@Lob
	@Getter @Setter private Byte[] image;
	
	@OneToOne(cascade = CascadeType.ALL)
	@Getter @Setter private Notes notes;
